        ...
        <div id="contact-container">
            ...
            <section class="left">
                ...
                >
                    ...
                    <div
                        id="orcamento"
                        v-if="assunto === 'Pedido de orçamento'"
                    >
                        <FormKit
                            type="text"
                            name="modelo"
                        ...
                        <span id="Modelos"
                            ><a
                                href="https://www.fefco.org/sites/default/files/files/styles/thumbnail/public/FEFCO%20Code_WEBprotected.pdf"
                                target="_blank"
                                >Verifique aqui os modelo disponíveis</a
                            ></span
                        >
            ...
            <section class="right">
                ...
                <div class="item">
                    ...
                    <span> <b>Email:</b> cartobox@cartobox.pt </span>
                </div>
            </section>
        </div>
    </div>
...
const submitHandler = async (data: any) => {
    ...
    const p = await new Promise(async (resolve, reject) => {
        ...
        await grecaptcha.ready(async function () {
            //@ts-ignore
            await grecaptcha
                .execute("6LclXzYmAAAAACni1BfBUnWJXg4Eb1b2KZ-8f4V5", {
                    action: "submit",
                })
